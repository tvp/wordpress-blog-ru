  ...
  <div id="content_wrap">
    ...
    <form method="post" id="the-theme-options">
      ...
      <div class="info top-info is-option-page">
        <h1><?php bloginfo('name'); ?> - Theme options</h1>
    <div class="version">
     Optiontree v.<?php echo OT_VERSION; ?>
    </div>
        ...
        <div id="options_tabs">
          ...
          <ul class="options_tabs">
            ...
            { 
              ...
              {
                echo '<li><a href="#option_'.$value->item_id.'">' . htmlspecialchars_decode( $value->item_title ).'</a></li>';
              } 
            } 
            ?>
          </ul>
      ...
      <div class="info bottom">
        ...
        <?php if ( $this->has_xml ) { ?>
        <input type="submit" value="<?php _e('Reload XML') ?>" class="button-framework reload-options" name="reload" style="margin:9px 0px 0 0;float:left;" />
        <?php } ?>
        <input type="submit" value="<?php _e('Save All Changes') ?>" class="button-framework save-options" name="submit"/>
